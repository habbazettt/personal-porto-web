        ...
        >
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                    <h2 className="headline-2 lg:max-w-[15ch] reveal-up">
                        Let&apos;s Connect and Collaborate
                    </h2>

                    <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
                        I&apos;m open to opportunities and eager to collaborate on exciting projects. Let&apos;s connect and explore the possibilities together!
                    </p>
                    ...
                    <div className="flex items-center gap-2 mt-auto">
                        {socialLinks.map(({ href, icon, }, key) => (
                            <a
                                ...
                                href={href}
                                target="_blank"
                                className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-colors hover:bg-zinc-50 hover:text-zinc-900 active:bg-zinc-50/80 reveal-up"
                            >
                                {icon}
                            </a>
                        ))}
                ...
                <form
                    action="https://getform.io/f/blllrxkb"
                    method="POST"
