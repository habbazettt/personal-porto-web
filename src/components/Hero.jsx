        ...
        >
            <div className="container lg:grid lg:grid-cols-2 lg:gap-10 items-center">
                <div>
                    ...
                    <h2 className="headline-1 sm:max-w-[20ch] lg:max-w-[15ch] mt-5 mb-8 lg:mb-10">
                        Empowering Digital Solutions through Web Development & UI/UX Design
                    </h2>

                    <div className="flex items-center gap-3">
                        <ButtonPrimary
                            href={'https://drive.google.com/file/d/1MPQloFcfzmXofgQELk3uRx1FG_abmPFL/view?usp=sharing'}
                            label="Download CV"
                            icon='download'
                            target="_blank" 
                        />
